...
RUN apk add --update --no-cache openssh-client gcc musl-dev libssh-dev bash git patch \
 ...
 && patch /usr/local/lib/python3*/site-packages/ansible_collections/vyos/vyos/plugins/module_utils/network/vyos/facts/firewall_rules/firewall_rules.py < /tmp/ansible.patch
